...
model.load_weights("logs/lstm1layer/" +name[score.index(min(score))])
testPredict = model.predict(test)
...
np.savetxt("res/lstm1layer/lstm1layer_exact.txt", dataoriginal)
np.savetxt("res/lstm1layer/lstm1layer_predict.txt", inv_testPredict)
